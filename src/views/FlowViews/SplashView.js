        ...
        return (
            <AnimatedStackView>
                <View style={styles.container}>
                    ...
                    <View style={{flex: 0, width:'100%', height:250, justifyItems:'center', alignItems:'center'}}>
                        <Image resizeMode={"contain"} style={{width:'90%', height:250}} source={this.ImageResources.get(this.props.info.image)}/>
                    </View>
                    <View style={{flexDirection: "row", flex:0, alignItems:'center', justifyItems: 'start', marginTop: 15}}>
                        <Label style={[{flex: 8, fontSize: 21, paddingLeft: 10, paddingRight: 10, width:'100%', textAlign:'left', alignItems:'center'}]}>{this.props.info.description}</Label>
                    </View>
