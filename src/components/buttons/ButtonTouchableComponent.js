...
class ButtonTouchableComponent extends React.Component {
    ...
    render() {
        return (
            <TouchableHighlight style={{opacity:global.state.arPinDropButtonDisable?0.3:1}} disabled={global.state.arPinDropButtonDisable} underlayColor="#00000000" onPress={this.onPress} onLongPress={this.onLongPress} delayLongPress={500}>
                <View style={{
                    textAlign: 'center',
